//Date updated
document.getElementById('last-up').innerText = "Last update: Sep 12th, 24; 1:24pm";
...
var statePolls = {
    ...
    "FL": calculateLead(45.7, 51.2), // Florida
    "GA": calculateLead(47.6, 48.4), // Georgia
    "MI": calculateLead(48.3, 47), // Michigan
    "MN": calculateLead(50.3, 43.5), // Minnesota
    "NV": calculateLead(48.1, 48.1), // Nevada
    "NH": calculateLead(51.9, 45.8), // New Hampshire
    "NC": calculateLead(48.1, 48.1), // North Carolina
    "PA": calculateLead(48, 47.8), // Pennsylvania
    "VA": calculateLead(49.9, 42.4), // Virginia
    ...
    "MD": calculateLead(60.4, 34.4), // Maryland
    ...
    "NM": calculateLead(50.1, 43.4), // New Mexico
    "NY": calculateLead(58, 42), // New York
    "ND": calculateLead(28, 62), // North Dakota
    "OH": calculateLead(43.7, 52.6), // Ohio
    ...
    "TX": calculateLead(45.7, 50.3), // Texas
